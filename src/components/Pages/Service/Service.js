    ...
    return (
        <div className='d-md-flex justify-content-between align-items-center container mt-md-5 mt-4 p-md-5 p-4 event-service'>
            ...
            <div className='w-100'>
                ...
                <button onClick={() => navigate('/checkout')} className='mt-4 btn btn-danger d-flex px-3 py-2 align-items-center'><ShoppingCartIcon className='cart-icon'></ShoppingCartIcon> Add To Cart</button>
            </div>
        </div>
    );
};
